             ...
             <nav>
                 <ul class="metismenu" id="menu">
                     ...
                     <li>
                         ...
                         <ul
                             class="collapse {{ $usr->can('role.create') || $usr->can('role.view') || $usr->can('role.edit') || $usr->can('role.delete') || $usr->can('admin.create') || $usr->can('admin.view') || $usr->can('admin.edit') || $usr->can('admin.delete') ? 'in' : '' }}">

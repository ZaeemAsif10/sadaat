                    ...
                    <div class="col-md-12 mt-3">
                        <table class="table">
                            ...
                            <tbody id="purchaseTable">
                                <tr>
                                    <td><input type="number" class="form-control numbere" name="number" placeholder="number"></td>
        ...
        $('#purchaseTable').on('change', '.select_product', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $currentRow.find('.cost').val(data.product_cost);
                    $currentRow.find('.number').val((c++));

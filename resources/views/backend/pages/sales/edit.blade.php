                                        ...
                                        <select name="warehouse_id" id="cus" class="form-control" required>
                                            ...
                                            @foreach ($warehouses as $warehouse)
                                                <option value="{{ $warehouse->id }}"
                                                    @if ($warehouse->id == $sale_first->warehouse_id) selected @endif>
                                        ...
                                        <select name="customer_id" id="cus1" class="form-control" required>
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}"
                                                    @if ($supplier->id == $sale_first->customer_id) selected @endif>
                                                ...
                                                @foreach ($sale_first->productsales as $key => $value)
                                                    <tr>
                                                        <td> <select name="product_id[]"
                                                                ...
                                                                <option value="" selected disabled>Choose Product
                                                                </option>
                                                        ...
                                                        <td><input type="text" class="form-control code" name="code[]"
                                                                value="{{ $value->product_code }}" placeholder="code">
                                                        </td>
                                                        ...
                                                        <td><input type="number" class="form-control cost"
                                                                name="price[]" value="{{ $value->product_unit_price }}"
                                                                placeholder="0.00">
                                                        </td>
  ...
  border-radius: 0px;" type="button" id="as" class="btn btn-success btn-sm"><i
                                                    ...
                                                    placeholder="0.00"></td> -->
                                                        <td><input type="number" class="form-control subtot"
                                                                name="product_subtot[]"
                                                                value="{{ $value->product_total_price }}"
                                                                placeholder="0.00"></td>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <input type="text" name="order_discount"
                                            value="{{ $sale_first->order_discount }}"
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <input type="text" name="shipping_cost"
                                            value="{{ $sale_first->shipping_cost }}" class="form-control shipping_cost"
                                            required>
                                    </div>
                                ...
                                <table class="table mt-4 table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Order Discount <span
                                                    class="float-right text-secondary all_disc">0.00</span></th>
                                            <th>Sub Total <span class="float-right text-secondary all_total">0.00</span>
                                            </th>
                                            <th>Grand Total <span
                                                    class="float-right text-secondary all_total granddsocount"
                                                    i>0.00</span></th>
                            ...
                            <div id="purchaseTable1" style="display: none;">
                                <table>
                                    <tr>
                                        <td> <select name="product_id[]" id="cus1"
                                                class="form-control select_product">
                                        ...
                                        <td><input type="number" class="form-control qty" name="qty[]"
                                                placeholder="0.00"></td>
                                        <td><input type="text" class="form-control cost" name="price[]"
                                                placeholder="0.00"></td>

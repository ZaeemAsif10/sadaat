                        ...
                        <div id="formdivnew">
                            <div class="form-row ">
                                ...
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <input type="text" required class="form-control" id="product_promotional_price"
                                        name="product_promotional_price">
                                </div>
                                <div class="form-group col-md-4 col-sm-12">
                                    <label for="product_unit">product promotional start</label>
                                    <input type="date" required class="form-control" id="product_promotional_start"
                                        name="product_promotional_start">
                                </div>
                                <div class="form-group col-md-4 col-sm-12">
                                    <label for="product_unit">product promotional end</label>
                                    <input type="date" required class="form-control" id="product_promotional_end"
                                        name="product_promotional_end">
                                </div>
                            </div>
